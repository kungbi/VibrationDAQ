...
namespace Enum {
template <typename T>
inline static const bool convert(
    const T &fromEnum, std::string &toEnumString,
    const std::map<T, std::string> &enumStringMap) {
...
inline static const std::string toString(
    const T &fromEnum, const std::map<T, std::string> &enumStringMap) {
...
template <typename T>
inline static const bool convert(
    const std::string &fromEnumString, T &toEnum,
    const std::map<T, std::string> &enumStringMap) {
