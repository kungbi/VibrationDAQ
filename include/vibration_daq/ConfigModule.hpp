...
class ConfigModule {
 private:
  ...
  static bool readVibrationSensor(const YAML::Node &node,
                                  VibrationSensorConfig &vibrationSensor);

  static bool readRecordingConfig(const YAML::Node &node,
 ...
 public:
   ...
   * @return true if read-out is successful
   */
  bool readExternalTriggerConfig(bool &externalTriggerActivated,
