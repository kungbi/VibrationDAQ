...
inline static const bool convert(const WindowSetting &fromWindowSetting,
                                 std::string &toWindowSettingString) {
  return convert(fromWindowSetting, toWindowSettingString,
                 WINDOW_SETTING_STRING_MAP);
}

inline static const bool convert(const std::string &fromWindowSettingString,
                                 WindowSetting &toWindowSetting) {
  return convert(fromWindowSettingString, toWindowSetting,
                 WINDOW_SETTING_STRING_MAP);
}
};  // namespace Enum
}  // namespace vibration_daq