...
inline static const bool convert(const FIRFilter &fromFIRFilter,
                                 std::string &toFIRFilterString) {
  return convert(fromFIRFilter, toFIRFilterString, FIR_FILTER_STRING_MAP);
}

inline static const bool convert(const std::string &fromFIRFilterString,
                                 FIRFilter &toFIRFilter) {
