...
inline const bool convert(const DecimationFactor &fromDecimationFactor,
                          std::string &toDecimationFactorString) {
  return convert(fromDecimationFactor, toDecimationFactorString,
                 DECIMATION_FACTOR_STRING_MAP);
}

inline const bool convert(const std::string &fromDecimationFactorString,
                          DecimationFactor &toDecimationFactor) {
  return convert(fromDecimationFactorString, toDecimationFactor,
                 DECIMATION_FACTOR_STRING_MAP);
}
};  // namespace Enum
}  // namespace vibration_daq