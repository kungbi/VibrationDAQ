...
namespace vibration_daq {
    ...
    bool VibrationSensorModule::parseRtsData(std::vector<uint16_t> &resp, VibrationData &vibrationData) const{
        if(resp.size() != 100){
    ...
    VibrationData VibrationSensorModule::readRtsSamplesBuffer(int samplesCount, 
